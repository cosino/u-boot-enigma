/*
 * Configuration settings for the HCE Enigma Industrial Development board.
 *
...
#define CONFIG_SYS_USB_OHCI_SLOT_NAME		"enigma industrial"
...
#define CONFIG_BOOTCOMMAND						\
	"setenv bootargs console=${console} ${optargs} ${videoargs} "	\
		" root=${rootfsargs}; "					\
...
#define CONFIG_EXTRA_ENV_SETTINGS CONFIG_EXTRA_ENV_SETTINGS_COMMON	\
        "rootfsargs=ubi0:rootfs ubi.mtd=7 rootfstype=ubifs\0"
#elif CONFIG_SYS_USE_MMC
/* override the bootcmd, bootargs and other configuration for sd/mmc env */
#define CONFIG_EXTRA_ENV_SETTINGS CONFIG_EXTRA_ENV_SETTINGS_COMMON	\
        "rootfsargs=/dev/mmcblk0p2 rw rootwait\0"
#else
