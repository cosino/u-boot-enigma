...
static void enigma_mci0_hw_init(void)
{
	at91_mci_hw_init();
...
static void enigma_mci1_hw_init(void)
{
...
static void enigma_lcd_hw_init(void)
{
...
void lcd_show_board_info(void)
{
	...
	lcd_printf("%s\n", U_BOOT_VERSION);
	lcd_printf("(C) 2015 HCE Engineering S.r.l.\n");
